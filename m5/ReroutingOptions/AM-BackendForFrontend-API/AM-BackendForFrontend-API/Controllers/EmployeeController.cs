...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<Employee> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<EmployeeController> _logger;

        public EmployeeController(IAccountManagerRepository<Employee> repository, IMapper mapper, LinkGenerator linkGenerator,
