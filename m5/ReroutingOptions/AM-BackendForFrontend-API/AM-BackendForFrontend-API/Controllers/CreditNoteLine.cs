...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<CreditNoteLine> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<CreditNoteLineController> _logger;

        public CreditNoteLineController(IAccountManagerRepository<CreditNoteLine> repository, IMapper mapper, LinkGenerator linkGenerator,
