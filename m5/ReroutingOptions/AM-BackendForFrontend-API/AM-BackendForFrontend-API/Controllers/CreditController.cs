...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<Credit> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<CreditController> _logger;

        public CreditController(IAccountManagerRepository<Credit> repository, IMapper mapper, LinkGenerator linkGenerator,
