...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<SMS> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<SMSController> _logger;

        public SMSController(IAccountManagerRepository<SMS> repository, IMapper mapper, LinkGenerator linkGenerator,
