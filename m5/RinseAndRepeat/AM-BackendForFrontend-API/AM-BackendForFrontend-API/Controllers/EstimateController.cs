...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IInvoiceManagerRepository<Estimate> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<EstimateController> _logger;

        public EstimateController(IInvoiceManagerRepository<Estimate> repository, IMapper mapper, LinkGenerator linkGenerator,
