...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IEmployeeManagerRepository<Training> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<TrainingController> _logger;

        public TrainingController(IEmployeeManagerRepository<Training> repository, IMapper mapper, LinkGenerator linkGenerator,
