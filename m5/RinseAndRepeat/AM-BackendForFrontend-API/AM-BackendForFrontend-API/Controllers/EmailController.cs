...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly INotificationsServiceRepository<Email> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<EmailController> _logger;

        public EmailController(INotificationsServiceRepository<Email> repository, IMapper mapper, LinkGenerator linkGenerator, 
