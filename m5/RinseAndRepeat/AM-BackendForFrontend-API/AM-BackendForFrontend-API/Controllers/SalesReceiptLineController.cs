...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IInvoiceManagerRepository<SalesReceiptLine> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<SalesReceiptLineController> _logger;

        public SalesReceiptLineController(IInvoiceManagerRepository<SalesReceiptLine> repository, IMapper mapper, LinkGenerator linkGenerator,
