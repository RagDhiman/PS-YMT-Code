...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IInvoiceManagerRepository<DelayedChargeLine> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<DelayedChargeLineController> _logger;

        public DelayedChargeLineController(IInvoiceManagerRepository<DelayedChargeLine> repository, IMapper mapper, LinkGenerator linkGenerator,
