...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IEmployeeManagerRepository<Absence> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<AbsenceController> _logger;

        public AbsenceController(IEmployeeManagerRepository<Absence> repository, IMapper mapper, LinkGenerator linkGenerator,
