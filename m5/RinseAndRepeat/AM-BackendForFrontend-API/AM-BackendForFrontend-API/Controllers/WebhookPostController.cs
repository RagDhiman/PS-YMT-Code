...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly INotificationsServiceRepository<WebhookPost> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<WebhookPostController> _logger;

        public WebhookPostController(INotificationsServiceRepository<WebhookPost> repository, IMapper mapper, LinkGenerator linkGenerator,
