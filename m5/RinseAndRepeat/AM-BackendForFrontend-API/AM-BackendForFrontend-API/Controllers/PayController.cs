...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IEmployeeManagerRepository<Pay> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<PayController> _logger;

        public PayController(IEmployeeManagerRepository<Pay> repository, IMapper mapper, LinkGenerator linkGenerator,
