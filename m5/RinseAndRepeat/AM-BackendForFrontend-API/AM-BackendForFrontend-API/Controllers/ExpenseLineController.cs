...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IExpenseManagerRepository<ExpenseLine> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<ExpenseLineController> _logger;

        public ExpenseLineController(IExpenseManagerRepository<ExpenseLine> repository, IMapper mapper, LinkGenerator linkGenerator,
