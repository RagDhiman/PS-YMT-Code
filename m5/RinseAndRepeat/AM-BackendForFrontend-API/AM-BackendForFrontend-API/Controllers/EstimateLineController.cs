...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IInvoiceManagerRepository<EstimateLine> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<EstimateLineController> _logger;

        public EstimateLineController(IInvoiceManagerRepository<EstimateLine> repository, IMapper mapper, LinkGenerator linkGenerator,
