...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IInvoiceManagerRepository<InvoiceLine> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<InvoiceLineController> _logger;

        public InvoiceLineController(IInvoiceManagerRepository<InvoiceLine> repository, IMapper mapper, LinkGenerator linkGenerator,
