...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IEmployeeManagerRepository<TaxInformation> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<TaxInformationController> _logger;

        public TaxInformationController(IEmployeeManagerRepository<TaxInformation> repository, IMapper mapper, LinkGenerator linkGenerator,
