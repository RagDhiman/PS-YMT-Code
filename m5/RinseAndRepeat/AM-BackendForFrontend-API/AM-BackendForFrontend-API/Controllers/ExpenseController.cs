...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IExpenseManagerRepository<Expense> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<ExpenseController> _logger;

        public ExpenseController(IExpenseManagerRepository<Expense> repository, IMapper mapper, LinkGenerator linkGenerator,
