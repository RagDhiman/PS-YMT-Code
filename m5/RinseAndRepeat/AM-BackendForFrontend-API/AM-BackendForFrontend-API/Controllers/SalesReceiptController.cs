...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IInvoiceManagerRepository<SalesReceipt> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<SalesReceiptController> _logger;

        public SalesReceiptController(IInvoiceManagerRepository<SalesReceipt> repository, IMapper mapper, LinkGenerator linkGenerator,
