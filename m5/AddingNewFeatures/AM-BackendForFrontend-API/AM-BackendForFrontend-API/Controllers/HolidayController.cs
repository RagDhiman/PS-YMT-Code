...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<Holiday> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<HolidayController> _logger;

        public HolidayController(IAccountManagerRepository<Holiday> repository, IMapper mapper, LinkGenerator linkGenerator,
