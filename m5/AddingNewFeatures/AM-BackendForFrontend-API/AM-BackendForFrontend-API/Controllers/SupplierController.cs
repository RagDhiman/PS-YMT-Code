...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<Supplier> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<SupplierController> _logger;

        public SupplierController(IAccountManagerRepository<Supplier> repository, IMapper mapper, LinkGenerator linkGenerator,
