...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<DelayedCharge> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<DelayedChargeController> _logger;

        public DelayedChargeController(IAccountManagerRepository<DelayedCharge> repository, IMapper mapper, LinkGenerator linkGenerator,
