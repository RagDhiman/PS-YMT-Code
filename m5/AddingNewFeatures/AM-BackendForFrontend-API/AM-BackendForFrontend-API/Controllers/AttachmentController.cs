...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<Attachment> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<AttachmentController> _logger;

        public AttachmentController(IAccountManagerRepository<Attachment> repository, IMapper mapper, LinkGenerator linkGenerator,
