...
namespace AM_BackendForFrontend_API.Controllers
{
    ...
    {
        private readonly IAccountManagerRepository<SupplierNote> _repository;
        private readonly IMapper _mapper;
        private readonly LinkGenerator _linkGenerator;
        private readonly ILogger<SupplierNoteController> _logger;

        public SupplierNoteController(IAccountManagerRepository<SupplierNote> repository, IMapper mapper, LinkGenerator linkGenerator,
